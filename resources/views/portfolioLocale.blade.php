...
<body>
	<section class="sect">
		...
		<nav>
			<!--logo-->
			<a href="#" class="logo">{{__('message.sms')}}</a>
			<!--menu-->
			<ul>
				<li><a href="#" class="active" onclick="window.location.reload()">H{{ __('message.sms1') }}</a></li>
				<li><a id = "about" onclick="change(this)" href="#">A{{__('message.sms2')}}</a></li>
				<li><a href="#" onclick="change(this)">H{{__('message.sms3')}}</a></li>
				<li><a href="#" onclick="change(this)">C{{__('message.sms4')}}</a></li>
			</ul>
		</nav>
		<!--Text0--0000------------------>
		<div class="text_container" id="text_container">
			<p>{{__('message.sms5')}}</p>
			<p>{{__('message.sms6')}}</p>
			<p>{{__('message.sms7')}}<br>{{__('message.sms8')}}</p>
			<button class="hire_btn">{{__('message.sms9')}}</button>
			<button class="down_cv">{{__('message.sms10')}}</button>
		</div>
	...
	<div class="about_container">
		...
		<div class="sec" id="about_container">
			...
			<div>
				<h2>{{__('message.sms11')}}</h2>
				<p>{{__('message.sms12')}}</p>
			</div>
		</div>
	...
	<div id="services">
		<div class="services_text">
			<p>{{__('message.sms13')}}</p>
			<p>{{__('message.sms14')}}</p>
			<p>{{__('message.sms15')}}</p>
		</div>
		<div class="body">
			<div class="container">
				<div class="card">
